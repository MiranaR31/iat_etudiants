define(['questAPI'], function(Quest){
	...
	*/	
    ...
    API.addSequence([
		...
		{inherit:'basicPage',
		 condition : '<%= current.questions.lieu_naissance.includes(1) %>',
		 questions:{inherit:'6'}},
		{inherit:'basicPage',
		 condition : '<%= current.questions.lieu_naissance.includes(2) %>',
		 questions:{inherit:'5.1'}},
		{inherit:'basicPage',
		 condition : '<%= current.questions.annee_france_1.includes(1) %>',
		 questions:{inherit:'5.3'}},
		{inherit:'basicPage',
		 condition : '<%= current.questions.annee_france_1.includes(2) %>',
