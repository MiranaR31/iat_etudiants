...
//séquence
    API.addSequence([
	    ...
	    questions: {
	        ...
	        type: 'text',
	        name: 'debug',
	        stem: 'DEBUG : Valeur enregistrée pour Q1 = <%= current.questions.licence %>'}},
		...
		{inherit: 'basicPage',
		 condition:'<%= current.questions.licence == 1 %>',
		...
		{inherit: 'basicPage', 
		 condition: '<%= current.questions.licence == 3 %>',
		 questions:[
		...
		{inherit: 'basicPage', 
		 condition: '<%= current.questions.licence == 4 %>',
		 questions:[
			 {inherit:'l3hpm1'},
			 {inherit:'l3hpm2'},
			 {inherit:'l3hpm3'},
